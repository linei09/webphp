        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Description: </td>
                    <td>
                        <textarea name="description" cols="30" rows=""><?php echo $description; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>Price: </td>
                    ...
                    <td>
                        <?php
                            if($current_image !="")
                            {
                                //display the img
                                ?>
                                <img src="<?php echo SITEURL; ?>model/images/food/<?php echo $current_image; ?>">
                                <?php
                            }
                            else
                            {
            ...
            if(isset($_FILES['image']['name']))
            {
                ...
                if($image_name !="")
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        $destination_path = "../../model/images/food/".$image_name;
                        ...
                        if($current_image!="")
                       {
                            ...
                            $remove_path = "../../model/images/food/".$current_image;
